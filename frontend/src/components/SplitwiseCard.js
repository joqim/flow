        ...
        {/* <CardActionArea> */}
          ...
          {this.state.message!=null && (<Snackbar
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <SplitwiseRegistrationModal onComplete={this.handleConfigSaveComplete} email={this.props.email}/>
            </div>
            ...
            {props.balances && (<Typography sx={{ mb: 1.5, fontSize: 14, ml: 0.5 }} color="text.secondary">
              balance
            </Typography>)}
            <Accordion style={{ backgroundColor: "#ebebeb", boxShadow: 'none', border: 'none', borderRadius: 0, marginTop: "25px", marginLeft: "-10px"}} disableGutters={true}>
              ...
              {props.balances && props.balances.map(item => {
